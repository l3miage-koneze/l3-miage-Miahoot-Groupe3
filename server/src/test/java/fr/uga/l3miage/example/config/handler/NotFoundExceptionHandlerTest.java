...
/**
 * Permet de tester le handler de l'exception d'API {@link EntityNotFoundRestException}
 */
class NotFoundExceptionHandlerTest {
    ...
    void testHandle() {
        ...
        EntityNotFoundRestException exception = new EntityNotFoundRestException("TestConfigWithProperties not found",-1L);
